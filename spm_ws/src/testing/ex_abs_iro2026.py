...
ax[1].plot(ts, roll_d, label="Desired Roll", color="red")
ax[1].plot(ts, roll_a, "--", label="Actual Roll", color="#F14637")
ax[1].set_ylabel("Angle (deg)", fontsize=15)
ax[1].grid(True)
ax[1].plot(ts, pitch_d, label="Desired Pitch", color="green")
ax[1].plot(ts, pitch_a, "--", label="Actual Pitch", color="#5FE471")
ax[1].legend(fontsize=15)
ax[0].grid(True)
ax[0].plot(ts, yaw_d, label="Desired Yaw", color="blue")
ax[0].plot(ts, yaw_a, "--", label="Actual Yaw", color="#35A5F0")
